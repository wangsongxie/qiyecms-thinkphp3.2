<div class="page-header">
    <h1>DateTimePicker
        <small>jQuery plugin select date and time</small>
    </h1>
</div>
<?php echo $this->parse('right250x250',array('link'=>"https://github.com/xdan/datetimepicker/archive/master.zip"))?>
<p>
    Use this plugin to unobtrusively add a datetimepicker, datepicker or timepicker dropdown to your forms. It's easy to
    customize options. <a href="https://github.com/xdan/datetimepicker">Source code on GitHub</a> or <a
            href="https://github.com/xdan/datetimepicker/archive/master.zip">download (zip)</a>.
</p>
...
<div class="row">
    <div class="col-lg-6">
      ...
      <span class="input-group-btn">
        <button id="image_button" class="btn btn-default" type="button"><span
...
<table class="table table-condensed table-bordered table-striped">
    ...
    <tr id="validateOnBlur">
        ...
        <td>true</td>
        <td>Verify datetime value from input, when losing focus. If value is not valid datetime, then to value inserts
    ...
    <tr id="mask">
        ...
        <td>false</td>
        <td>Use mask for input. true - automatically generates a mask on the field &#39;format&#39;, Digit from 0 to 9,
            set the highest possible digit for the value. For example: the first digit of hours can not be greater than
            2, and the first digit of the minutes can not be greater than 5
        </td>
